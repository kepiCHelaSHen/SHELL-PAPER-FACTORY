...
Create D:\EXPERIMENTS\SUNK_COST\ with:
  ...
  devlog/, src/, papers/, papers/sunk_cost_2025/,
  papers/sunk_cost_2025/figures/, prompts/
...
Also write prompts/turn_prompts_log.md:
  # TURN PROMPTS LOG — sunk_cost_2025
...
the slug set to "sunk_cost_2025". Use the template from
D:\EXPERIMENTS\SHELL\prompts\00_init.md Step 15, replacing [SLUG] with
sunk_cost_2025 and [SLUG] paths with SUNK_COST.
...
When done write papers/sunk_cost_2025/paper.md and halt.
