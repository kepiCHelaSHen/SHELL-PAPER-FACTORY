...
Also write prompts/turn_prompts_log.md:
  # TURN PROMPTS LOG — doomscrolling_2026
...
YOUR INPUTS:
  ...
  DATA: No empirical data. All results derived analytically from the optimal stopping model.
  SLUG: doomscrolling_2026
