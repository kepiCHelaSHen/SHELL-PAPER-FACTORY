...
![Figure 1: State Opioid Prescribing Rates](run1/figures/fig1_state_opioid_rates.png){width=95%}
...
![Figure 3: Top 15 Specialties](run1/figures/fig3_specialty_rates.png){width=90%}
...
![Figure 2: Lorenz Curve](run1/figures/fig2_lorenz_opioid.png){width=80%}
...
![Figure 4: Variance Decomposition](run1/figures/fig4_variance_decomposition.png){width=75%}
...
![Figure 8: OLS Coefficients](run1/figures/fig8_ols_coefficients.png){width=90%}
...
![Figure 9: Raw vs Adjusted](run1/figures/fig9_raw_vs_adjusted.png){width=80%}
...
![Figure 5: Lorenz by Specialty](run1/figures/fig5_lorenz_by_specialty.png){width=85%}
...
![Figure 7: State Rate vs Gini](run1/figures/fig7_state_rate_vs_gini.png){width=80%}
