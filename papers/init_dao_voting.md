...
Create C:\PROJECTS\SHELL\papers\DAO_VOTING\ with:
...
Copy from C:\PROJECTS\SHELL\prompts\ into C:\PROJECTS\SHELL\papers\DAO_VOTING\prompts\:
...
Write run_pipeline.ps1 in the project root (C:\PROJECTS\SHELL\papers\DAO_VOTING\) with
...
### Step 8 — Initialize git
  cd C:\PROJECTS\SHELL\papers\DAO_VOTING
  git init
  git add -A
...
YOUR INPUTS:
  ...
  DATA: Real DAO token distributions required (Uniswap, Compound, MakerDAO, Aave). Frozen spec parameters are analytical definitions.
  SLUG: dao_voting_2026
